...
The intention of Section 6 is to document certain aspects of SDMX that
are important to understand and will aid implementation decisions. The
explanations here supplement the information documented in the SDMX
XML/JSON schemas and the Information Model.
