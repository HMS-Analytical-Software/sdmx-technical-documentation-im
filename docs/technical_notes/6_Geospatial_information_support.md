...
- **GEO\_INFO\_TYPE**. Coded information describing a standard format
    ...
    (<https://www.loc.gov/preservation/digital/formats/fdd/gis_fdd.shtml>).
...
types of the SDMX Information Model. A "GEO\_FEATURE\_SET" role should
...
"GEO\_FEATURE\_SET" role assigned; it can be included in a dataset or
metadataset.
...
“GEO\_FEATURE\_SET” role. Its Representation would be of
...
((X\_COORDINATE Y\_COORDINATE ALT, X\_COORDINATE Y\_COORDINATE ALT, …),
(X\_COORDINATE Y\_COORDINATE ALT, X\_COORDINATE Y\_COORDINATE ALT, …),
…), …): GEO \_DESCRIPTION}, {(POLYGON Z ((X\_COORDINATE Y\_COORDINATE
ALT, X\_COORDINATE Y\_COORDINATE ALT, …), (X\_COORDINATE Y\_COORDINATE
ALT, X\_COORDINATE Y\_COORDINATE ALT, …), …), POLYGON Z ((X\_COORDINATE
Y\_COORDINATE ALT, X\_COORDINATE Y\_COORDINATE ALT, …), (X\_COORDINATE
Y\_COORDINATE ALT, X\_COORDINATE Y\_COORDINATE ALT, …), …), POLYGON Z
((X\_COORDINATE Y\_COORDINATE ALT, X\_COORDINATE Y\_COORDINATE ALT, …),
(X\_COORDINATE Y\_COORDINATE ALT, X\_COORDINATE Y\_COORDINATE ALT, …),
...
"GEO\_FEATURE\_SET" role/specification. This approach uses a specialized
...
in the grid, which is made by adding the GEO\_CELL element to each item
...
As an example, GEO\_TAG can take the values of the Open Location Codes,
